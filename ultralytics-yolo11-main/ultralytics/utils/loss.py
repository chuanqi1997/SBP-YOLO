...
class BboxLoss(nn.Module):
    ...
    def __init__(self, reg_max=16):
        ...
        # NWD
        self.nwd_loss = True # default False
        self.nwd_loss = False # default False
        self.iou_ratio = 0.5 # total_iou_loss = self.iou_ratio * iou_loss + (1 - self.iou_ratio) * nwd_loss  default：0.5
        
        # WiseIOU
        self.use_wiseiou = False # default False
        if self.use_wiseiou:
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask, mpdiou_hw=None):
        ...
        if self.nwd_loss:
            print(f"🚀NWD_LOSS{self.iou_ratio}")
