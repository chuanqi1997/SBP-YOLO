...
class Model(nn.Module):
    ...
    def train(
        ...
        **kwargs,
        ...
        # if hasattr(self, str(self.trainer.save_dir) ):  # 确保配置路径存在
        save_dir = str(self.trainer.save_dir)
        model_name = self.model_name
        cfg_backup_path = Path(save_dir) / "config_backup.yaml"
        import shutil
        shutil.copy(model_name, cfg_backup_path)
        print(f"✅ Config backup saved to {cfg_backup_path}\r\n")
        # ===== 新增配置备份 =====
