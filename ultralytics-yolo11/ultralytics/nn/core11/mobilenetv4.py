...
__all__ = ['MobileNetV4ConvUltraSmall', 'MobileNetV4ConvSmall', 'MobileNetV4ConvMedium', 'MobileNetV4ConvLarge', 'MobileNetV4HybridMedium', 'MobileNetV4HybridLarge']

MNV4ConvUltraSmall_BLOCK_SPECS = {
    "conv0": {
        "block_name": "convbn",
        "num_blocks": 1,
        "block_specs": [
...
MODEL_SPECS = {
    "MobileNetV4ConvUltraSmall" : MNV4ConvUltraSmall_BLOCK_SPECS,
