...
# from ultralytics.nn.extra_modules.ska import SKA
...
if __name__ == "__main__":
    B, ed, resolution = 1, 64, 128
    model = Block(ed=ed, kd=16, stage=3, depth=1, resolution=resolution)
    
    x = torch.randn(B, ed, resolution, resolution)
