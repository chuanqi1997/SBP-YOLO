...
class GhostModule(nn.Module):
    def __init__(self, inp, oup, kernel_size=1,  stride=1, ratio=2, dw_size=5, relu=True, mode='ori',args=None):
        ...
        self.infer_mode = True # default： 法拉瑟
        ...
        if self.mode in ['ori']:
            ...
            if self.infer_mode:  
                self.primary_conv = nn.Sequential(  
                    ...
                    default_act if relu else nn.Sequential(),#MODIFY 
                )
